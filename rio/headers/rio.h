...
FFIResult file_open(FFIString path);

FFIResult file_create(FFIString path);

FFIResult file_read(const FFIHandle *file_handle, FFIBytes buffer);

FFIResult file_read_to_end(const FFIHandle *file_handle);

FFIResult file_write(const FFIHandle *file_handle, FFIBytes buffer);

FFIResult file_write_all(const FFIHandle *file_handle, FFIBytes buffer);
...
FFIResult stderr_write(const FFIHandle *stderr_handle, FFIBytes buffer);

FFIResult stderr_write_all(const FFIHandle *stderr_handle, FFIBytes buffer);
...
FFIResult stdout_write(const FFIHandle *stdout_handle, FFIBytes buffer);

FFIResult stdout_write_all(const FFIHandle *stdout_handle, FFIBytes buffer);

FFIResult stdout_flush(const FFIHandle *stdout_handle);

void free_stdout(const FFIHandle *stdout_handle);

FFIResult path_init(FFIBytes buffer);

FFIResult path_push(const FFIHandle *handle, FFIBytes buffer);

FFIResult path_pop(const FFIHandle *handle);

FFIResult path_set_file_name(const FFIHandle *handle, FFIBytes buffer);

FFIResult path_set_extension(const FFIHandle *handle, FFIBytes buffer);
